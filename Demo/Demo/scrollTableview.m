...
static
void scroll_indicator_position(scrollTableview *scrollView, int indicatorType)
{
...
static
UIImage *scroll_indicator_default_image(UITableView *scrollView, int indicatorType)
{
    NSUInteger index =
...
- (void)setShowsVerticalScrollIndicatorAlways:(BOOL)showsVerticalScrollIndicatorAlways
{
    if (_showsVerticalScrollIndicatorAlways != showsVerticalScrollIndicatorAlways) {
        ...
        if (showsVerticalScrollIndicatorAlways) {
            ...
            NSLog(@"TableHeight--%f",self.frame.size.height);
            NSLog(@"Table Content height--%f",self.contentSize.height);
